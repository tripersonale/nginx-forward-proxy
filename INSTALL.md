# INSTALL — Guida installazione passo-passo

> **Stile IKEA**: 12 step da "Diventa root" a "Avvia il servizio".
> Ogni step mostra comando, output atteso, checkpoint. Zero assunzioni.
> Durata: ~30 minuti (di cui ~5 min di build nginx).

**Prima di iniziare**: leggi tutta la sezione "Prima di cominciare"
sotto per ambiente, ingredienti, e subnet autorizzata.

Per aggiornare un deploy esistente, vedi [`UPGRADE.md`](./UPGRADE.md)
